  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <Link to="/shop">
          <Button variant="hero" size="lg" className="rounded-full pl-8 pr-6 py-6 text-lg mt-8 group">
            <span className="relative z-10 transition-colors duration-300">Explore All Products</span>
            <ArrowRight className="ml-3 h-5 w-5 relative z-10 transition-colors duration-300" />
          </Button>
        </Link>
      </div>
    </section>
